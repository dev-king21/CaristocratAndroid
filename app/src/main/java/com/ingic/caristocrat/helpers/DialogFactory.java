...
public class DialogFactory {
    ...
    public static void listDialog(final Activity activity,
                                  DialogInterface.OnClickListener dialogPositive,
                                  String title,
                                  List<String> list, boolean cancelable) {
    ...
    public static void regionsListDialog(final Activity activity,
                                         DialogInterface.OnClickListener dialogPositive,
                                         String title,
                                         List<Region> list) {
        ...
        AlertDialog.Builder builderSingle = new AlertDialog.Builder(activity);
        builderSingle.setTitle(title);
        final ArrayAdapter<Region> arrayAdapter = new ArrayAdapter<>(activity, R.layout.item_list_dialog);
        arrayAdapter.addAll(list);
        builderSingle.setAdapter(arrayAdapter, dialogPositive);
        AlertDialog dialog = builderSingle.create();
        dialog.show();

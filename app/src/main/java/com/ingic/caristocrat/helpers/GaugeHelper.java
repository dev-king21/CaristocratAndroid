...
public class GaugeHelper extends LinearLayout {
    ...
    public GaugeHelper(Context context, AttributeSet attrs) {
        super(context, attrs);
        if(!isInEditMode()){
            LayoutInflater layoutInflater = (LayoutInflater)context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            layoutInflater.inflate(R.layout.meter_layout,this);
            initView();
        }
    ...
    {
        this.gaugeBackground=R.drawable.bar2;
...
//        guageBack.setBackgroundResource(R.drawable.degrees);
    ...
    public void setCurrentAngle(float angle)
    {
        ...
        needleDeflection.setAnimationListener(new Animation.AnimationListener() {@Override
